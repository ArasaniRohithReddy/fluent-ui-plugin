...
- **873 documented media items**, **every one carrying a non-empty `alt` and a direct URL** — **856 images** (458 on component pages + 278 on topic pages) + **17 Motion demo videos** (`.mp4`). 92 of them are do/don't pairs.
