...
- **Rate limits.** A **View/Collab seat, or any Starter plan, gets ~6 tool calls per month** — enough to fail, not enough to work. Dev/Full seats get 200/day on Professional and Organization, 600/day on Enterprise. **A Dev seat on Professional is the realistic floor.** Code Connect additionally requires **Organization or Enterprise**. Tell the user before they start.
