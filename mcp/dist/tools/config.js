...
export function registerConfig(server) {
    ...
    }, async ({ projectDir, brandColor, targets, accessibilityLevel, themeMode, shape, controlSize, iconStyle, migrationFrom, executionProfile, fanOut, powerbiNormalizeInline, webFramework, guidelines, constraints, references, force, }) => {
        const root = projectRoot(projectDir);
