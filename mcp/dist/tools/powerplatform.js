...
export function registerPowerplatform(server) {
    server.registerTool('fluent_powerplatform_guidance', {
        ...
        description: 'Return grounded, Microsoft-Learn-cited guidance for applying Fluent 2 on Power Platform: Power Apps (modern controls + modern themes), Power Pages (Bootstrap + Fluent design-token CSS), or PCF code components (Fluent React v9 via platform libraries + context.fluentDesignLanguage).',
        inputSchema: {
            surface: z
