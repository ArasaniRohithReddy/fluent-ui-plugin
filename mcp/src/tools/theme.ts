    ...
    'fluent_generate_theme',
    {
      ...
      inputSchema: {
        ...
        hueTorsion: z
          ...
          .default(0)
          .describe(
            'Optional. The Theme Designer\'s "Hue Torsion" slider, -50..50 (passed upstream as hueTorsion/100). Rotates the curve through LAB space so the ramp travels through neighbouring hues. 0 = no rotation.'
          ),
        darkCp: z
          .number()
          .min(-1)
          ...
          .optional()
          .describe(
            'Advanced. Raw upstream control point of the Bezier curve toward black, overriding vibrancy. getBrandTokensFromPalette\'s own library default is 2/3 - note the Theme Designer never uses it, because its vibrancy slider passes an explicit 0.'
          ),
        lightCp: z
          .number()
          .min(-1)
          ...
          .optional()
          .describe(
            'Advanced. Raw upstream control point of the Bezier curve toward white, overriding vibrancy. getBrandTokensFromPalette\'s own library default is 1/3.'
          ),
      },
    },
