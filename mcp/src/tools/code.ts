...
export function registerCode(server: McpServer): void {
  server.registerTool(
    'fluent_generate_code',
    {
      ...
      description:
        'Scaffold Fluent 2 web code (React v9 or Web Components): an app shell with FluentProvider, a themed form, a card, or a Copilot chat starter. Uses makeStyles + tokens — no hardcoded values.',
      inputSchema: {
