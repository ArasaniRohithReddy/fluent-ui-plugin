...
## MCP tools
`fluent_search_components`, `fluent_get_component`, `fluent_list_tokens`, `fluent_get_token`, `fluent_generate_theme`, `fluent_generate_powerbi_theme`, `fluent_scaffold_pbip`, `fluent_pbir_audit`, `fluent_pbir_apply_theme`, `fluent_pbir_normalize_inline`, `fluent_pbir_verify`, `fluent_powerbi_visuals`, `fluent_powerplatform_guidance`, `fluent_generate_code`, `fluent_accessibility_checklist`, `fluent_design_guidance`, `fluent_migration_guidance`, `fluent_get_images`, `fluent_get_config`, `fluent_init_config`, `fluent_set_config`, `fluent_remember`, `fluent_recall`, `fluent_v8_lookup`, `fluent_v8_guidance`, `fluent_native_component`, `fluent_native_guidance`, `fluent_figma_guidance`.
...
- **Figma:** `fluent_figma_guidance`. Check entitlement first — a View/Collab seat or any Starter plan gets ~6 tool calls per **month**. Auth belongs to the host; never ask for or store a Figma token.
